...
def talker():
    ...
    pub4 = rospy.Publisher('/reloc001/relocMesh', Marker)	
    rospy.init_node('RelocNode')

    robot_viz = Marker()
    robot_viz.header.frame_id="/odom"
    robot_viz.type = Marker.MESH_RESOURCE
    robot_viz.action = Marker.ADD
    robot_viz.mesh_resource = "Package://mesh/p3at.stl"
    robot_viz.scale.z = 0.1
    robot_viz.color.a = 1
    pub4.publish(robot_viz)
