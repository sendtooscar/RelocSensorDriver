...
def talker():
    ...
    while not rospy.is_shutdown():
	    #br.sendTransform((pioneer1[0], pioneer1[1], pioneer1[2]),(0.0, 0.0, pioneer1[3], pioneer1[4] ),rospy.Time.now(),"/pioneer1/base_reloc2","/map")
	    #br.sendTransform((pioneer1[0], pioneer1[1], pioneer1[2]),(0.0, 0.0, pioneer1[3], pioneer1[4] ),rospy.Time.now(),"/pioneer1/odom","/map")
	    #br.sendTransform((pioneer2[0], pioneer2[1], pioneer2[2]),(0.0, 0.0, pioneer2[3], pioneer2[4] ),rospy.Time.now(),"/pioneer2/odom","/map")
	    #br.sendTransform((pioneer2[0], pioneer2[1], pioneer2[2]),(0.0, 0.0, pioneer2[3], pioneer2[4] ),rospy.Time.now(),"/pioneer2/base_reloc2","/map")
	    br.sendTransform((drone1[0], drone1[1], drone1[2]),(0.0, 0.0, drone1[3], drone1[4] ),rospy.Time.now(),"/drone1/base_reloc2","/map")
	    #br.sendTransform((0.0, 0.0, 0.4),(0.0, 0.0, 0.0, 1.0 ),rospy.Time.now(),"/drone1/base_reloc2","/pioneer1/base_link")
	    rospy.sleep(0.01)
...
def callback1(msg):
    ...
    pioneer1[3]=odom_quat[2]
    pioneer1[4]=odom_quat[3]
...
def callback2(msg):
    ...
    odom_quat[3]=msg.pose.pose.orientation.w
    odom_euler= euler_from_quaternion(odom_quat)
    pioneer2[3]=odom_quat[2]
    pioneer2[4]=odom_quat[3]
...
def callback3(msg):
    ...
    odom_quat[3]=msg.pose.pose.orientation.w
    odom_euler= euler_from_quaternion(odom_quat)
    drone1[3]=odom_quat[2]
    drone1[4]=odom_quat[3]
